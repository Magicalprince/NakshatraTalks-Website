...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://api.nakshatratalks.com wss://api.nakshatratalks.com wss://*.nakshatratalks.com https: wss://*.twilio.com wss://*.chunderw-vpc-gll.twilio.com https://*.twilio.com wss://*.supabase.co",
