...
export default function BrowseCallPage() {
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent) => {
    if ((e.metaKey || e.ctrlKey) && e.key === 'k') {
      e.preventDefault();
      const searchInput = document.querySelector<HTMLInputElement>('[data-search-input="browse-call"]');
      searchInput?.focus();
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background-offWhite">
      <PageContainer>
        <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Call with Astrologer' }]} />
