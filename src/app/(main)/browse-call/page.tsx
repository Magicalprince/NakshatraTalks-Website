...
export default function BrowseCallPage() {
  ...
  // Handle astrologer call action
  const handleCallAction = (astrologer: Astrologer) => {
    if (!isAuthenticated) {
      addToast({
        type: 'info',
        title: 'Login Required',
        message: 'Please login to start a call session',
      });
      router.push(`/login?redirect=/browse-call`);
      return;
    }
    ...
    <div className="min-h-screen bg-background-offWhite">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-text-primary">Call with Astrologer</h1>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!isLoading && !isSearchLoading && (
          ...
          >
            {isSearching && searchQuery
              ...
              : `${astrologers.length} astrologers available for call`}
          </motion.p>
        )}
        ...
        <AstrologerGrid
          ...
          onAstrologerAction={handleCallAction}
        />
      </div>
    </div>
  );
