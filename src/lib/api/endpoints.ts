...
export const API_ENDPOINTS = {
  ...
  CHAT: {
    ...
    SEND: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}/messages`,
    MARK_READ: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}/read`,
    TYPING: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}/typing`,
    UPLOAD: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}/upload`,
    RATING: (sessionId: string) => `/api/v1/chat/sessions/${sessionId}/rating`,
    INITIATE: '/api/v1/chat/request',
  ...
  CALL: {
    ...
    HISTORY: '/api/v1/call/sessions',
    ACTIVE_SESSION: '/api/v1/call/sessions/active',
    SESSION: (sessionId: string) => `/api/v1/call/sessions/${sessionId}`,
    ...
    CANCEL: (requestId: string) => `/api/v1/call/request/${requestId}/cancel`,
