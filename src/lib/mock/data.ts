...
export const MOCK_ASTROLOGERS: Astrologer[] = [
  ...
  },
  {
    ...
    pricePerMinute: 30,
    chatPricePerMinute: 30,
    callPricePerMinute: 35,
    rating: 4.8,
    totalCalls: 3890,
    totalReviews: 1890,
    isAvailable: true,
  ...
  },
  {
    ...
    pricePerMinute: 35,
    chatPricePerMinute: 35,
    callPricePerMinute: 40,
    rating: 4.9,
    totalCalls: 7210,
    totalReviews: 3210,
    isAvailable: false,
...
export const MOCK_LIVE_SESSIONS: LiveSession[] = [
  ...
  },
  {
    id: 'live-2',
    astrologerId: '6',
    astrologerName: 'Swami Anand Giri',
    astrologerImage: 'https://randomuser.me/api/portraits/men/67.jpg',
