...
export const MOCK_ASTROLOGER_STATS: AstrologerStats = {
  ...
  totalDuration: 8100,
  avgDuration: 18,
  avgSessionDuration: 1080,
  rating: 4.9,
  totalReviews: 2345,
  ratingDistribution: { '5': 1800, '4': 400, '3': 100, '2': 30, '1': 15 },
  totalCalls: 170,
};
...
export const MOCK_DAILY_HOROSCOPES: Record<string, DailyHoroscope> = {
  aries: {
    ...
    day: 'today',
    horoscope: { general: 'Today brings exciting opportunities for career advancement. Your natural leadership qualities will shine, attracting positive attention from superiors. Financial matters look favorable, with potential for unexpected gains. In matters of the heart, open communication will strengthen bonds.' },
    luckyNumber: 9,
    luckyColor: 'Red',
    compatibility: 'Leo',
  },
  taurus: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'A peaceful day awaits you. Focus on completing pending tasks and organizing your space. Financial stability continues, making it a good time for small investments. Romantic relationships benefit from quiet moments together.' },
    luckyNumber: 6,
    luckyColor: 'Green',
    compatibility: 'Virgo',
  },
  gemini: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Your communication skills are at their peak today. Networking opportunities may lead to exciting collaborations. Be mindful of expenses and avoid impulsive purchases. Social activities bring joy and new connections.' },
    luckyNumber: 5,
    luckyColor: 'Yellow',
    compatibility: 'Libra',
  },
  cancer: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Family matters take center stage today. Your nurturing nature will be appreciated by loved ones. Property-related matters may require attention. Trust your intuition in making important decisions.' },
    luckyNumber: 2,
    luckyColor: 'Silver',
  ...
  leo: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Your creative energy is high today. Express yourself through art, music, or any creative pursuit. Recognition at work is likely. Romance flourishes under your warm and generous approach.' },
    luckyNumber: 1,
    luckyColor: 'Gold',
    compatibility: 'Aries',
  },
  virgo: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Attention to detail serves you well today. Health matters improve with proper care. Work projects benefit from your analytical approach. Avoid overthinking in relationships; trust the process.' },
    luckyNumber: 3,
  ...
  libra: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Harmony in relationships is highlighted today. Partnership opportunities arise in business. Artistic pursuits bring satisfaction. Balance your giving nature with self-care.' },
    luckyNumber: 7,
    luckyColor: 'Pink',
  ...
  scorpio: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Transformation and renewal are themes today. Financial insights lead to better planning. Deep conversations strengthen bonds. Trust your instincts in navigating complex situations.' },
    luckyNumber: 8,
    luckyColor: 'Maroon',
  ...
  sagittarius: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Adventure calls today. Travel plans may materialize. Learning new skills brings joy. Optimism attracts positive opportunities. Share your wisdom with those who seek guidance.' },
    luckyNumber: 4,
    luckyColor: 'Purple',
    compatibility: 'Aries',
  },
  capricorn: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Career ambitions get a boost today. Your disciplined approach pays off. Long-term investments look favorable. Take time to acknowledge your achievements.' },
    luckyNumber: 10,
    luckyColor: 'Brown',
    compatibility: 'Taurus',
  },
  aquarius: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Innovation and originality mark your day. Group activities bring fulfillment. Technology-related ventures succeed. Embrace your unique perspective; it inspires others.' },
    luckyNumber: 11,
  ...
  pisces: {
    ...
    date: new Date().toISOString().split('T')[0],
    day: 'today',
    horoscope: { general: 'Spiritual insights guide your path today. Creative and artistic pursuits flourish. Compassion strengthens relationships. Dreams may hold meaningful messages; keep a journal.' },
    luckyNumber: 12,
